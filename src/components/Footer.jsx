...
const Footer = () => {
  ...
  return (
    <div className={`${pathname === "/login" || isDashboard ? "hidden" : " block w-full"}`}>
      <footer className="second rounded-tr-2xl rounded-tl-2xl shadow dark:bg-slate-900 ">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          ...
          <span className="flex flex-col md:flex-row items-start sm:justify-between text-sm text-gray-400 sm:text-center "><Link href="/" className="hover:underline">© 2024 Barland.</Link>All Rights Reserved.</span>
        </div>
      </footer>
    </div>
  )
