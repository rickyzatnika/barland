      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        {step === "2" && (
          <div className="h-[95vh] w-full sm:h-[90vh] sm:pb-14 overflow-hidden antialiased">
            ...
            <div className="h-full pt-3 pb-36 sm:pb-8 sm:py-12 px-4 grid grid-cols-5 sm:grid-cols-7 md:grid-cols-10 2xl:grid-cols-12  gap-[1px] sm:gap-2 no-scrollbar overflow-y-scroll">
