    ...
    <div className='w-full h-full py-4 sm:py-14 mb-8 flex flex-col gap-6 items-center justify-center'>
      <div className="w-full flex flex-col md:flex-row gap-8 md:gap-2 items-start justify-center">
        <div className="w-full flex flex-col flex-1 gap-3 p-4 md:p-8">
          <h1 className="text-2xl text-gray-600 font-bold md:text-3xl">IKUTI BALAP NASIONAL PIALA PRESIDEN 2024</h1>
          ...
          <Link className="text-center w-max py-2 text-sm shadow-lg px-4 bg-gradient-to-tr from-green-400 to-lime-500 text-white rounded-xl " href="/pendaftaran">DAFTAR SEKARANG</Link>
        </div>
